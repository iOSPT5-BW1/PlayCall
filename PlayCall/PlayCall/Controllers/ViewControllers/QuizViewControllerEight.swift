...
class QuizViewControllerEight: UIViewController {
    ...
    @IBAction func playCallButtonPressed(_ sender: Any) {
        soundController.playSound(fileName: "E12-MotionZSweep-Snap1", fileType: "mp3")
    }
    
    @IBAction func answerButtonPressed(_ sender: UIButton) {
        let userAnswer = sender.currentTitle
        let correctAnswer = "E12-MotionZSweep-Snap1"
        Score.totalCount += 1
