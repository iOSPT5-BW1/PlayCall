...
class QuizViewControllerSix: UIViewController {
    ...
    @IBAction func playCallButtonPressed(_ sender: Any) {
        soundController.playSound(fileName: "E12-DoublePassFlyGo-Snap2", fileType: "mp3")
    }
    
    @IBAction func answerButtonPressed(_ sender: UIButton) {
        let userAnswer = sender.currentTitle
        let correctAnswer = "E12-DoublePassFlyGo-Snap2"
