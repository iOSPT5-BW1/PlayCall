...
class QuizViewControllerFour: UIViewController {
    ...
    @IBAction func playCallButtonPressed(_ sender: Any) {
        soundController.playSound(fileName: "E12-BubbleYSwitch-Snap3", fileType: "mp3")
    }
    
    
    @IBAction func answerButtonPressed(_ sender: UIButton) {
        let userAnswer = sender.currentTitle
        let correctAnswer = "E12-BubbleYSwitch-Snap3"
        Score.totalCount += 1
