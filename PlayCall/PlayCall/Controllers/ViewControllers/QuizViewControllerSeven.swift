...
class QuizViewControllerSeven: UIViewController {
    ...
    @IBAction func playCallButtonPressed(_ sender: Any) {
        soundController.playSound(fileName: "E12-HitchZOpen-Snap2", fileType: "mp3")
    }
    
    @IBAction func answerButtonPressed(_ sender: UIButton) {
        let userAnswer = sender.currentTitle
        let correctAnswer = "E12-HitchZOpen-Snap2"
