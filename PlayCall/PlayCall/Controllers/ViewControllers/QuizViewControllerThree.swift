...
class QuizViewControllerThree: UIViewController {
    ...
    @IBAction func playCallButtonPressed(_ sender: UIButton) {
        soundController.playSound(fileName: "E12-ChristineSpecialY-Snap2", fileType: "mp3")
    }
    
    @IBAction func answerButtonPressed(_ sender: UIButton) {
        let userAnswer = sender.currentTitle
        let correctAnswer = "E12-ChristineSpecialY-Snap2"
